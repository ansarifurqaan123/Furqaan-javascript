...
// }
// console.log(`Use Power ${power}`);---bahar power ki value use hi nhi ho gi q ki if and else ki jo brckts hai wo apna ek scope bana deti hai and uske andar ki chize bahar glbl scpe me use nhi ho gi

// jaise ek aur tarika hota hai implicit way ushe khte hai jisse ek line me pura code likhte hai par wo acha nhi hai
// const bal = 1000
// if(bal<5000) console.log("less"), console.log("Greater"); ye immature code hai ishe koi psnd nhi krta hai
